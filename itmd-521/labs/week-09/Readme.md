...
![errorifexists screenshot](images/ErrorExits(PY).png)
...
```
## Screenshots of the output of the SQL DESCRIBE command

![aces screenshot](images/aces(PY).png)


![left_table screenshot](images/lefttable(PY).png)


![left_tempview screenshot](images/lefttempview(PY).png)


![left_df screenshot](images/leftdf(PY).png)
